...
var Load = function(){
    obj_data.bg.img = new Image();
    obj_data.bg.img.src = obj_data.bg.url;
    ...
    obj_data.bg.img.onload = function(){
        ctx.drawImage(obj_data.bg.img, 0, 0, canvas.width, canvas.height);
        console.log("bg");
    };
...
var my_onload = function(){
    obj_data.bg.url = imgs[Math.floor(Math.random()*5)];
